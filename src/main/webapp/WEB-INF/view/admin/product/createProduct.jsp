        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-body p-4">
                    ...
                    <form:form action="/admin/product/create" method="post" modelAttribute="newProduct" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <!-- Sold (mặc định 0) -->
                            <div class="col-md-6 mb-3">
                                <label for="sold" class="form-label">Sold (default: 0)</label>
                                <form:input path="sold" class="form-control" id="sold" type="number" min="0" value="0"/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" id="noImage">
    ...
    $(document).ready(function() {
        ...
        $('#imageFile').on('change', function(event) {
            ...
            if (file) {
                ...
                // Uncheck "No Image" nếu user chọn file
                $('#noImage').prop('checked', false);
            }
        });
        
        // Toggle image upload khi check/uncheck "No Image"
